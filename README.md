...
> Current maintenance release: v1.9.3 maintenance release after v1.9.2, documenting dashboard composable refactoring, Vitest frontend unit tests, and GitHub Actions frontend lockfile compatibility.
